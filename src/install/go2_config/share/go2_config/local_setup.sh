...
: ${AMENT_CURRENT_PREFIX:="/home/drone/comp0244_ws/comp0244-go2/src/install/go2_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_config/environment/path.sh"
