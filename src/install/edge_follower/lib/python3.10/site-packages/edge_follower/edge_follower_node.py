...
class EdgeFollowerNode(Node):
    ...
    def find_next_waypoint(self):
        ...
        #                 # If we reach the last edge, extend beyond it
        #                 current_index = len(self.current_edges) - 1
        #                 edge_direction = (end - start) / np.linalg.norm(end - start)
        #                 current_point = end + edge_direction * increment_left  # Extend past last edge
        #                 break
        # else:
        ...
        #             current_index -= 1
        #             if current_index < 0:
        #                 # If we reach the first edge, extend beyond it in reverse direction
        #                 current_index = 0
        #                 edge_direction = (end - start) / np.linalg.norm(end - start)
        #                 current_point = start - edge_direction * increment_left  # Extend before first edge
        #                 break
