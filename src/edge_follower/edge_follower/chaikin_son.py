...
class EdgeFollowerNode(Node):
    def __init__(self):
        ...
        self.MIN_EDGE_LENGTH = 0.1  # Minimum edge length to consider
        self.CURVATURE_THRESHOLD = 0.05  # Threshold for keeping points with high curvature
        self.CHAIKIN_ITERATIONS = 3  # Number of iterations for Chaikin smoothing
        self.JOIN_ANGLE_THRESHOLD = 0.5  # radians - threshold for joining collinear edges
        self.SMOOTHING_ANGLE_THRESHOLD = math.radians(60)  # Maximum allowed angle change
    ...
    def stuck_rotation(self):
        ...
        # Move forward 50cm
        new_x = self.current_x + forward_vector[0] * 0.50
        new_y = self.current_y + forward_vector[1] * 0.50
