#!/usr/bin/env python3
"""
Launch file for Task 2: Bug0.
This launch file only launches the Bug0 node, as the environment (robot + SLAM + Waypoint Follower)
should be launched separately using:
    ros2 launch robot_launch.launch.py

After launching the environment, launch this file:
    ros2 launch cw1_team_12 run_solution_task_2.launch
...
def generate_launch_description():
    ...
    # Launch Bug0 node with configuration
    bug0_node = Node(
        package='cw1_team_12',
        ...
        remappings=[
            # Configure topic remappings for Bug0 node
    ...
    # Create launch description with just the Bug0 node
